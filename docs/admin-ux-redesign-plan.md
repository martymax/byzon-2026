...
| `AUX-00B` | U0  | [ ]  | governance    | Zapsat AUX→F4/P/CS mapování do hlavního plánu a založit branch/handoff pravidlo    | `AUX-00A`                                                                                                                                   | —                                                                                      | `AUX-00C`                                                                   | N/A                                                      | N/A               | — / §0.3–0.5                                                   |
...
- [ ] **00B-1:** Hlavní plán výslovně převezme mapování §0.5, AUX refaktor F4,
