...
| ---------------------------- | ---- | ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------ |
| `GAP-AUX-SHELL-01`           | [ ]  | Produkční shell má context adapter a route gate; chybí staging E2E evidence všech rout                                 | `AUX-13A`, `P9` / 2026-09-01                                              | shell `integrated`                  | Čistý view + oddělený mock adapter hotovy; zavře staging auth/context E2E evidence                     |
...
| `AUX-13A` | U0  | [!]  | integration   | Produkční shell/context a bezpečný per-route gate                                  | `AUX-02G`                                                                                                                                   | `GAP-AUX-SHELL-01`                              | `AUX-13C`                                                                   | `CS-ADMIN-01`, `GAP-AUX-SHELL-01`                        | integrated        | — / security→code review→fix; staging auth/context E2E a sync všech autorit                                                |
