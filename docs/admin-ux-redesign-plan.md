...
- Seznam rezervací: bezpečná maskovaná reference, stav, kontextová akce.
  Nový session-first DTO maskování smluvně validuje; dnešní produkční obecný
  `participantReference` tuto garanci ještě nemá a nahradí jej `AUX-13F`.
...
Plný target má připravenou session-level agregaci a stránkování; do její
produkční integrace nesmí UI předstírat kompletní globální kapacitní přehled.
Současná obrazovka proto omezení první stránky výslovně sděluje.
...
| `AUX-13E` | U1  | [!]  | integration   | `/admin/ucastnici` search a support actions                                        | `AUX-06D`, `AUX-13A`, `P4-09`, `P9-03`                                                                                                      | `BLOCKER-AUTH-01`, `BLOCKER-RES-03`, `GAP-AUX-SUPPORT-ACTIONS-01` | `AUX-13B`, `AUX-13D`                                                        | `CS-SUPPORT-01`                                          | integrated        | — / PII/security E2E + docs sync                                                                                     |
