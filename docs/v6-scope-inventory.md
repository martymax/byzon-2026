...
| `SCOPE-2026-09` 30min coaching                           | obecná reservation schema je připravena                                       | specializovaný coaching kontrakt není implementován                                                  | bez vymyšlených slotů/dostupnosti                                                                         | otevřeno v `F3-06`/`P5-06`                                                   |
