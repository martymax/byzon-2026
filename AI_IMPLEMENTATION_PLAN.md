...
- [ ] `P0-06` Udělat asset/content inventuru `data/content.json` → cílové entity.
- [ ] `P0-07` Změřit současný veřejný web a vytvořit regresní smoke test, že monorepo změny jej nerozbijí.
